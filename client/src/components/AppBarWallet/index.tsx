...
export function AppBarWallet() {
  ...
  switch (status) {
    default:
    case "WEB3_STARTUP":
      return <StyledConnectButton style={{ whiteSpace: "nowrap" }}>Connect web3</StyledConnectButton>;
    case "WEB3_CONNECTED":
      return <StyledConnectButton style={{ whiteSpace: "nowrap" }}>{account}</StyledConnectButton>;
    case "NO_WEB3":
